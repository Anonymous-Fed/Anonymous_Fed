...
def read_params():
    ...
    parser.add_argument('--s', help='line search parameter of S-FedLF', type=int, default=1)  
    ...
    parser.add_argument('--lam', help='parameter tau in Ditto', type=float, default=0.1)
