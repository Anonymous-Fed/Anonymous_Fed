...
class DataLoader_cifar10_dir(fp.DataLoader):
    def __init__(self,
        ...
        if params is not None:
            ...
            batch_size = params['B']
        name = 'CIFAR10_dir_pool_' + str(pool_size) + 'alpha_' + str(alpha) + '_batchsize_' + str(batch_size) + '_sort_split_input_require_shape_' + str(input_require_shape)
        nickname = 'cifar10 dir B' + str(batch_size) + ' alpha'+ str(alpha) + ' N' + str(pool_size)
