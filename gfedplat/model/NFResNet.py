...
class NFResNet(fp.Module):
    ...
    def generate_model(self, input_data_shape, target_class_num, vgg_name='VGG11', *args, **kwargs):
        self.model = NFResNet_Model(self.ignore_head, target_class_num, self.block, self.layers, alpha=self.alpha, beta=self.beta, activation=self.activation, base_conv=self.base_conv)
